...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+254748177557</li>	
					<li class="s-bar">
						<div class="search">
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<p>Providing guests unique and enchanting views from their rooms with its exceptional amenities, makes Sunrise Hotel one of bests in its kind.Try our food menu, awesome services and friendly staff while you are here.</p>
									</div>
								</div>
							</div>
						</div>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/issabel.png" alt=" " class="img-responsive" />
					</li>
					<li>
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>isabel njoroge G126/1299/2021</h4>
							<span>Manager</span>
							<p>Pain itself, because it is pain, sometimes produces a good .</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>hilda makena G126/1268/2021</h4>
					...
					<div class="tab3">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Moses kamuti G126/2234/2020</h4>
							<span>Manager</span>
							<p>Pain itself, because it is pain, sometimes produces a good.</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
					...
					<!---<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Edward sila G126/1297/2021</h4>
							<span>Receptionist</span>
							<p>Pain itself, because it is pain, sometimes produces a good.</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+254745827843</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="sunriserh@gmail.com">INFO@SUNRISEH.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> University Road, kitui, kwa vonza</p>
			...
			<iframe src="https://www.google.com/maps/place/Kwa+Vonza/@-1.2648979,37.573188,11z/data=!3m1!4b1!4m6!3m5!1s0x1825bbe2694e4855:0xac71860dc73c8d94!8m2!3d-1.2180377!4d37.745028!16s%2Fg%2F11h77tz_cw?entry=ttu" ></iframe>
		</div>
		<div class="clearfix"></div>
	</div>
</section>
